            ...
            <div className="flex  max-w-sm mx-auto p-2 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-grey-800 lg:max-w-4xl">
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 ">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        <span className="w-1/5 border-b dark:border-grey-600 lg:w-1/4"></span>

                        <Link to="/" className="text-xs text-center text-grey-500 uppercase dark:text-grey-400 hover:underline">or sign up with</Link>

                        <span className="w-1/5 border-b dark:border-grey-400 lg:w-1/4"></span>
                    </div>
                    ...
                    <div className="mt-4">
                        <div className="flex flex-col justify-between">
                            <Input label="Password" color='teal' size='lg' />
                            <Link to="/" className="text-xs text-grey-500 dark:text-grey-300 hover:underline">Forget Password?</Link>
                        </div>
                ...
                <div className="hidden  md:w-1/2 md:flex justify-center items-center ">
                    <div className="w-full " >
                        <div className=" outline outline-offset-8 outline-primary w-72 h-72 md:w-[25rem] md:h-[25rem]   rounded-full p-5 md:p-10">
                            <div className="h-full w-full rounded-full bg-primary md:p-10 p-5 ">
                                <div className=" bg-contain bg-no-repeat bg-center  bg-hero-auth  w-full h-full"></div>
                            </div>
                        </div>
                    </div>
                </div>
