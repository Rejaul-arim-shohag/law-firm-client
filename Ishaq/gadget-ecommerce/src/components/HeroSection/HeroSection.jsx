...
export default function HeroSection() {
  ...
  return (
    <div className='relative md:py-16 py-14 md:pt-16 bg-gradient-to-r from-[#b0eacd8b]'>
      <div className="w-full hidden md:block   h-full absolute -top-64 md:top-0 -left-20 bg-hero-wave bg-contain bg-left bg-no-repeat"></div>
      ...
      <div className="flex flex-col md:flex-row container justify-between md:pt-14">
        <div className="heroText md:w-1/2 p-5">
          ...
          <div className="search relative my-5">
            ...
            <button className='py-3 absolute px-3 md:right-[6.5rem] right-1  text-xs md:top-[.3em] top-1 bg-primary text-white font-bold rounded-full hover:bg-[#21bf73c7] duration-150'>Search Product</button>
          </div>
          <Stats />
          <RecentProducts />
