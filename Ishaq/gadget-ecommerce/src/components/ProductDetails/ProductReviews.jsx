        ...
        <div>
            <section>
                <div className="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 ">
                    ...
                    <div className="grid grid-cols-2 mt-8 lg:grid-cols-4 gap-x-16 gap-y-12">
                        <blockquote>
                            ...
                            <p className="mt-2 text-gray-700 line-clamp-3 md:line-clamp-none">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullam possimus fuga dolor rerum dicta, ipsum laboriosam est totam iusto alias incidunt cum tempore aliquid aliquam error quisquam ipsam asperiores! Iste?</p>
