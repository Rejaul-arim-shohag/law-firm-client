...
export default function CategoryItem({ i, item, pageNo, perPage, slug, handleAllData, checkBoxChangeHandler }) {
  ...
  return (
    <tr >
      <Modal open={openEdit} setOpen={setOpenEdit} item={<UpdateCategory slug={slug} perPage={perPage} item={item} setOpen={setOpenEdit} />} />
