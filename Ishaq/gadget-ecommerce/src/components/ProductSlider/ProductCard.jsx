    ...
    return (
        <div>
            <div className="max-w-sm mx-1 overflow-hidden bg-white rounded-lg shadow-md ">
                ...
                <div className="p-2">
                    <div>
                        <Link to="/details" className="block text-sm md:text-base no-underline font-semibold text-dark transition-colors duration-200 transform  hover:text-primary ">OnePlus 10 Pro Case Ultra Hybrid</Link>
